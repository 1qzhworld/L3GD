...
x_coll_opt_p05m9, x_coll_omgd_p05m9, x_coll_l3gd_p05m9, x_coll_ongd_p05m9 = \
    main(a_plan, b_plan_rand, attack_dict95, prob, alg_setting_thm_dim_stp)
...
x_coll_opt_p04m9, x_coll_omgd_p04m9, x_coll_l3gd_p04m9, x_coll_ongd_p04m9 = \
    main(a_plan, b_plan_rand, attack_dict94, prob, alg_setting_thm_dim_stp)
...
x_coll_opt_p03m9, x_coll_omgd_p03m9, x_coll_l3gd_p03m9, x_coll_ongd_p03m9 = \
    main(a_plan, b_plan_rand, attack_dict93, prob, alg_setting_thm_dim_stp)
...
x_coll_opt_p02m9, x_coll_omgd_p02m9, x_coll_l3gd_p02m9, x_coll_ongd_p02m9 = \
    main(a_plan, b_plan_rand, attack_dict92, prob, alg_setting_thm_dim_stp)
...
x_coll_opt_p01m9, x_coll_omgd_p01m9, x_coll_l3gd_p01m9, x_coll_ongd_p01m9 = \
    main(a_plan, b_plan_rand, attack_dict91, prob, alg_setting_thm_dim_stp)
...
savefig = True
fig_name = start_time.strftime('DiffProb_rand_thm_dim_stp' + '_%Y%m%d_%H%M')
if savefig:
    print(os.getcwd())
    try:
...
ax.set_ylabel(r'$EReg_T^d/T$')
savefig = True
fig_name = start_time.strftime('DiffProb_rand_cst_stp' + '_%Y%m%d_%H%M')
if savefig:
    print(os.getcwd())
    try:
        plt.savefig('./synthetic_examples/assets/results_syn_{}.png'.format(fig_name), dpi=300)
...
savefig = True
fig_name = start_time.strftime('DiffProb_rand_compare' + '_%Y%m%d_%H%M')
if savefig:
    print(os.getcwd())
    try:
        plt.savefig('./synthetic_examples/assets/results_syn_{}.png'.format(fig_name), dpi=300)
