...
savefig = True
fig_name = start_time.strftime('DiffProb_cos500_thm_dim_stp' + '_%Y%m%d_%H%M' + '_AtkRand')
if savefig:
    print(os.getcwd())
    try:
...
ax.set_ylabel(r'$EReg_T^d$')
savefig = True
fig_name = start_time.strftime('DiffProb_cos500_cst_stp' + '_%Y%m%d_%H%M' + '_AtkRand')
if savefig:
    print(os.getcwd())
    try:
        plt.savefig('./synthetic_examples/assets/results_syn_{}.png'.format(fig_name), dpi=300)
...
ax.set_ylabel(r'$EReg_T^d$')
savefig = True
fig_name = start_time.strftime('DiffProb_cos500_compare' + '_%Y%m%d_%H%M' + '_AtkRand')
if savefig:
    print(os.getcwd())
    try:
        plt.savefig('./synthetic_examples/assets/results_syn_{}.png'.format(fig_name), dpi=300)
